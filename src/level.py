...
#           ^color stuff for background here!!
    ...
    def game(self):
        ...
        slime = Mobs.Slime(self.display, [16 * 36, 16 * 14 - 2], 'images/level_3/Slime', [16, 16], [30, 30], [30],
                                [30])
        slime2 = Mobs.Slime(self.display, [16 * 100, 16 * 14 - 2], 'images/level_3/Slime', [16, 16], [30, 30],
                                 [30], [30])
        snake = Mobs.Snakeworm(self.display, [16 * 22, 13 * 16], 'images/level_1/Snakeworm', [16, 16], [30, 30],
                                    [30, 30], [30])
